...
namespace Framework_05
{
    public class Factory
    {
        ...
        public GameObject createGameObject(PictureBox pictureBox,bool hasGravity,int speed,IOneDMovement movement,Rolls roll)
        {
            charactersListCounter[(int)roll] += 1;
            return new GameObject(pictureBox, hasGravity, speed, movement);
        }
        public GameObject createGameObject(PictureBox pictureBox, bool hasGravity, int speed, ITwoDMovement movement, Rolls roll)
        {
            charactersListCounter[(int)roll] += 1;
            return new GameObject(pictureBox, hasGravity, speed, movement);
        }
        public GameObject createGameObject(PictureBox pictureBox, bool hasGravity, int speed, IMultiDMovement movement, Rolls roll)
        {
            charactersListCounter[(int)roll] += 1;
            return new GameObject(pictureBox, hasGravity, speed, movement);
        }
